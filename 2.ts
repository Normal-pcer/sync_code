...
function modifyMainPage() {
    if (window.location.href !== "https://www.luogu.com.cn/")  return;
    document
        .querySelector(
            "#app-old > div.lg-index-content.am-center > div:nth-child(1) > div > div > div > div.am-u-md-8"
        )
        ?.remove();
    let rightBar = document.querySelector(
        "#app-old > div.lg-index-content.am-center > div:nth-child(3) > div.am-u-lg-3.am-u-md-4.lg-right"
    ) as HTMLElement;
    let luck = document.querySelector(
        "#app-old > div.lg-index-content.am-center > div:nth-child(1) > div > div > div > div"
    ) as HTMLElement;
    ...
    let upBar = document.querySelector(
        "#app > div.main-container > div.wrapper.wrapped.lfe-body.header-layout.tiny > div.container"
    ) as HTMLElement;
